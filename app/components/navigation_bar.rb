  ...
  class NavigationBar < Components::Base
    def view_template
      nav(
        ...
        button(
          class: 'relative flex h-14 w-14 items-center justify-center rounded-3xl bg-pulse-sage/10 text-pulse-forest transition-all active:scale-90'
        ) do
          nav_icon('house', 'w-6 h-6')
