module Seed
  class GeminiCompleter < ApplicationService
    ...
    def prompt
      <<~PROMPT
        ...
        Voici la structure attendue :
        {
          ...
          "growth_months": [strings en anglais minuscules],
          "bloom_months": [strings en anglais minuscules],
          "fruit_months": [strings en anglais minuscules],
    ...
    def unparsed_response_with_retries
      ...
      puts "[Gemini] Limite atteinte ou erreur réseau. Nouvel essai dans #{RETRY_DELAYS[@retries]}s... (Tentative #{@retries + 1})"
