...
Rails.application.configure do
  ...
  # Deterministic encryption (e.g. Sensor#secret_key) needs keys in every environment.
  # These are test-only values; production continues to use config/credentials.
